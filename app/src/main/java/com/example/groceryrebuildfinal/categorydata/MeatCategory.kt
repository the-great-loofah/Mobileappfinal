...
import com.example.groceryrebuildfinal.categorydata.meatList
import com.example.groceryrebuildfinal.ui.theme.Typography

class MeatCategory: GroceryCategory("Meat", meatList)
{
    companion object{fun getDefault(): MeatCategory = MeatCategory()} // Static object
